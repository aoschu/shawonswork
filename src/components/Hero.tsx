...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center py-20 bg-gradient-to-br from-portfolio-blue to-portfolio-blue/90 overflow-hidden">
      {/* Decorative elements */}
          ...
          <div className="md:col-span-7 space-y-8 text-white animate-fade-in">
            ...
            <div className="flex flex-wrap gap-6 pt-6">
              <Button
                ...
                className="bg-yellow-400 hover:bg-yellow-500 text-portfolio-blue font-semibold px-8 py-6 rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105"
                size="lg"
              >
                View Portfolio
              </Button>
              <Button
                ...
                className="bg-transparent text-white hover:bg-white/10 font-semibold px-8 py-6 rounded-full border-2 border-white/70 transition-all duration-300 hover:border-white"
                size="lg"
              >
